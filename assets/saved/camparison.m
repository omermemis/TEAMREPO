...
MarkerSize = 15;
LineWidth = 2.0;
figure('Name','computationTime','position',[0 0 2000 1000])


subplot(1,2,1)
hold on
grid on
plot(compTime.CMPC.mean,'Color',[0.4660 0.6740 0.1880],'Marker','*','MarkerSize',MarkerSize,'LineStyle','-')
plot(compTime.CMPC.max,'Color',[0.4660 0.6740 0.1880],'Marker','s','MarkerSize',MarkerSize,'LineStyle','--')
plot(compTime.DMPC.mean,'Color',[0 0.4470 0.7410],'Marker','*','MarkerSize',MarkerSize,'LineStyle','-')
plot(compTime.DMPC.max,'Color',[0 0.4470 0.7410],'Marker','s','MarkerSize',MarkerSize,'LineStyle','--')
...
xlim([1 10])
legend({'centralized MPC (mean)','centralized MPC (max)','distributed MPC (mean)','distributed MPC (max)','step size of the HC'},'FontSize',FontSize,'location','northwest')
...
hold on
grid on
plot(objectiveVal.CMPC.total,'Color',[0.4660 0.6740 0.1880],'Marker','*','MarkerSize',MarkerSize,'LineStyle','-')
plot(objectiveVal.DMPC.total,'Color',[0 0.4470 0.7410],'Marker','*','MarkerSize',MarkerSize,'LineStyle','-')

title('Comparison of objective value')
xlabel('number of vehicles','FontSize',FontSize)
